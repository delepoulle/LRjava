...
public class Sphere extends Primitive {
	...
	if(delta==0.0){
	    ...
	    if(t1>EPSILON) t=t1; else t=t2;
	}

	// calcul du point d'intersection
	
	//	 return new Point(r.x+t*r.dx, r.y+t*r.dy, r.z+t*r.dz);
	 return new Intersection(o.x+t*d.getX(),
				 o.y+t*d.getY(),
				 o.z+t*d.getZ(),
				 this, t);
	...
	if(delta==0.0){
	    ...
	    if((t2>EPSILON)&&(t2<tmax-EPSILON)) return true;
	}
	return false;	    
    }
