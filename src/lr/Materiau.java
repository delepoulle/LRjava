...
public class Materiau {
    ...
    /**
     * Construction d'un matériau par défaut. Les longueurs d'onde considérées sont
     * au nombre de 3 (rouge, vert et bleu) et les coefficients sont initialisés de
     * manière identique pour les 3 longueurs d'onde : 0.2 pour la réflexion
     * ambiante, 0.8 pour la réflexion diffuse et 0.0 pour la réflexion spéculaire.
     * Le coefficient spéculaire est également nul.
     */
    public Materiau() {
     ...
     * coefficients de réflexion sont données sous forme de tableaux, supposés de
     * taille 3 (rouge, vert, bleu).
     * 
     * @param amb       tableau contenant les coefficients de réflexion ambiant pour
     *                  le rouge, le vert et le bleu
     * @param dif       tableau contenant les coefficients de réflexion diffus pour
     *                  le rouge, le vert et le bleu
     ...
     * 
     * @return un tableau de taille 3, dont les cases représentent respectivement
     *         les coefficients de réflexion ambiante pour le rouge, le vert et le
     *         bleu
     */
     ...
     * 
     * @return un tableau de taille 3, dont les cases représentent respectivement
     *         les coefficients de réflexion diffuse pour le rouge, le vert et le
     *         bleu
     */
     ...
     * 
     * @return un tableau de taille 3, dont les cases représentent respectivement
     *         les coefficients de réflexion spéculaire pour le rouge, le vert et le
     *         bleu
     */
     ...
     */
    public float getCoeffSpec() {
        return coeffSpec;
    }

    /**
     * Permet de déterminer si le matériau comporte une composante spéculaire. Ce
     * test est effectué en vérifiant que l'un des facteurs de réflexion spéculaire
     * est non nul.
     * 
     ...
     * 
     * @return Une chaîne de caractères qui représente le matériau. les coefficients
     *         de réflextion ambiants, diffus et spéculaire sont affichés
     */
