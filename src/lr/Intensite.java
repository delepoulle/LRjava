...
public class Intensite {
    ...
    /**
     * crée une intensité. L'intensité de chaque longueur d'onde (R,V,B) doit être
     * positive ou nulle. En cas de valeur négative, celle-ci est remplacée par une
     * valeur nulle.
     * 
     * @param r la valeur (réelle) de l'intensité pour la longueur d'onde du rouge
    ...
    /**
     * crée une intensite. L'intensité fournie dans le paramètre i est copiée dans
     * l'objet courant.
     * 
    ...
    /**
     * fournit la valeur de l'intensité pour la longueur d'onde du rouge. La valeur
     * obtenue se trouve dans l'intervalle [0,1]. Si la valeur stockée dans l'objet
     * est supérieure à 1, la valeur retournée vaudra 1.
     * 
    ...
    /**
     * fournit la valeur de l'intensité pour la longueur d'onde du vert. La valeur
     * obtenue se trouve dans l'intervalle [0,1]. Si la valeur stockée dans l'objet
     * est supérieure à 1, la valeur retournée vaudra 1.
     * 
    ...
    /**
     * fournit la valeur de l'intensité pour la longueur d'onde du bleu. La valeur
     * obtenue se trouve dans l'intervalle [0,1]. Si la valeur stockée dans l'objet
     * est supérieure à 1, la valeur retournée vaudra 1.
     * 
    ...
    /**
     * Convertit la valeur de l'intensité courante sous forme d'une instance de la
     * classe Color.
     * 
     * @return la représentation de l'intensité de l'objet courant sous forme d'une
    ...
    /**
     * additionne une intensité à l'intensité courante. L'intensité à ajouter est
     * fournie sous forme d'une valeur pour chaque longueur d'onde (R,V,B).
     * 
     * @param r la valeur de l'intensité à ajouter pour la longueur d'onde du rouge
    ...
    /**
     * additionne une intensité à l'intensité courante. L'intensité à ajouter est
     * fournie sous forme d'une autre intensité.
     * 
    ...
    /**
     * divise l'intensité courante par un scalaire. Le résultat obtenu est une
     * intensité nulle si le scalaire est 0.
     * 
    ...
    /**
     * teste l'égalité de 2 intensités. La comparaison s'effectue longueur d'onde
     * par longueur d'onde.
     * 
