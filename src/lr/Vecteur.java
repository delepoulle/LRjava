...
public class Vecteur {
    ...
    /**
     * calcule le produit scalaire entre le vecteur courant et le vecteur passé en
     * paramètre.
     * 
    ...
    /**
     * calcule le produit vectoriel entre le vecteur courant et le vecteur passé en
     * paramètre. Le sens du produit est le suivant : this x v
     * 
    ...
    public Vecteur produitVectoriel(Vecteur v) {
        return new Vecteur(dy * v.dz - dz * v.dy, dz * v.dx - dx * v.dz, dx * v.dy - dy * v.dx);
    }
    ...
    /**
     * effectue la différence entre le vecteur courant et le vecteur passé en
     * paramètre. Le sens de la soustraction est le suivant : this - v.
     * 
    ...
    /**
     * divise le vecteur courant par le scalaire passé en paramètre. Le sclaire doit
     * être différent de 0, sous peine de déclencher une exception.
     * 
