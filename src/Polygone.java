...
public class Polygone extends Primitive {
    ...
    /**
     * Constructeur par défaut de polygone. Crée un carré horizontal, de côté 1, centré sur l'origine. 
    ...
    /**
     * Crée un polygone à partir d'une suite de points et d'un materiau. 
     * La suite des points est donnée par un tableau de Points et le materiau est une instance de la classe Materiau.
     * @param tabSom Tableau de points qui définit le polygone.
     * @param m instance de la classe Materiau qui défini les propriétés de réflexion du materiau.
     */
    ...
    /**
     * Crée un polygone à partir d'une suite de points, de leur normale et d'un materiau. 
     * La suite des points est donnée par un tableau de Points.
     * La suite des normales est donnée par un tableau de Vecteurs.
     * Le materiau est une instance de la classe Materiau.
     * @param tabSom Liste des sommets. Donnée sous la forme d'un tableau de points.
     * @param tabNormale Liste des normales. Donnée sous la forme d'un tableau de vecteurs.
	...
	if(tabNormale!=null){
		...
		this.tabNormale[tabSom.length] =
		    new Vecteur(tabNormale[0]);
	    }else{
