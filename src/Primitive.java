 ...
 * apparaître dans une scène. Cette classe ne contient aucune information concernant la géométrie de l'objet. Par contre elle contient les informations permettant de connaître les propriétés du matériau dont l'objet est constitué (voir la classe Materiau). 
 */
public abstract class Primitive {
    ...
    /** Crée une primitive. Celle-ci est caractérisée uniquement par ses caractéristiques photométriques, c'est à dire les différents coefficients de réflexion utilisé dans le modèle de Phong.
     * @param ambiant un tableau contenant les coefficients de réflexion ambiante du matériau de la primitive
     * @param diffus un tableau contenant les coefficients de réflexion diffuse du matériau de la primitive
    ...
    /** Permet de déterminer si un rayon coupe la primitive. La différence par rapport à la méthode intersecte réside dans le fait que cette méthode ne calcule pas le point d'intersection éventuel, ce qui permet un gain de temps. Cette méthode est utile pour calculer l'intensité lumineuses transmise par un rayon d'ombrage.
    ...
    /** Permet de calculer la normale à la surface de la primitive au point d'intersection fournit en paramètre.
    ...
    /** Calcule l'éclairage de la source au point d'intersection i situé sur la primitive courante. La formule de calcul utilisée est la formule de Phong, prenant en compte l'éclairage ambiant, diffus et spéculaire.
   ...
   /** Calcule l'éclairage ambiant du à la source au point d'intersection i situé sur la primitive courante. Seul l'éclairage ambiant apparaissant dans la forumle de Phong est pris en compte.
     * @param i le point d'intersection situé sur la primitive courant
     * @param s la source dont on souhaite calculer la contribution
     * @param obs la position de l'observateur
     * @return l'intensité calculée
    ...
    /** Calcule le rayon réflechi au point d'intersection. Le rayon réflechi est obtenu en considérant une réflexion spéculaire pure.
     * @param i le point d'intersection situé sur la primitive courant
     * @param incident le vecteur correspondant à la direction d'incidence du rayon qui est à l'origine de l'intersection.
    ...
    /** Détermine si l'objet est composé d'un matériau comportant une composante spéculaire. 
     * @return true si le matériau de l'objet comporte une composante spéculaire, false sinon
     */
    public boolean isSpecular(){ return mat.isSpecular();}
