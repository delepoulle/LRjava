...
/**
 * Permet de stocker et de manipuler une image (sous forme d'une grille de pixels).
 */
public class Image {
     ...
     * @param format Chaîne de caractères qui représente le format de sauvegarde. L'extention est automatiquement ajoutée
     * à la fin du fichier.
