public class Vecteur {
    ...
    /** calcule le produit vectoriel entre le vecteur courant et le vecteur passé en paramètre. Le sens du produit est le suivant : this x v
    ...
    /** effectue la différence entre le vecteur courant et le vecteur passé en paramètre. Le sens de la soustraction est le suivant : this - v.
	...
	dz /= f;
        ...
        /** teste l'égalité de objets instances de vecteur 3D. La comparaison s'effectue coordonnée par coordonnée.
	...
	if( dx != v.dx ) return false;
	if( dy != v.dy ) return false;
	if( dz != v.dz ) return false;
