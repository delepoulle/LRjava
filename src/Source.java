/** Classe permettant la représentation d'une source ponctuelle. Une source est caractérisée par sa position dans l'espace et ses valeurs d'intensité selon les composantes RVB.
 */
public class Source {
    ...
    /** Construit une source par défaut. La source est positionnée en (0,0,1) et son intensité est fixée à (1.0,1.0,1.0).
     */
    public Source(){
    ...
    /** Construit une source positionnée en p. Son intensité est fixée par défaut à (1.0,1.0,1.0).
