/** Classe définissant les caractéristiques d'un matériau. Ces caractéristiques sont adaptées au modèle de réflexion de Phong et incluent les coefficients de réflexion (ambiante, diffuse et spéculaire) pour chaque longueur d'onde considérée, et le coefficient de spécularité.
 */
public class Materiau {
    ...
    /** Construction d'un matériau spécifique. Les valeurs des différents coefficients de réflexion sont données sous forme de tableaux, supposés de taille 3 (rouge, vert, bleu).
     * @param amb tableau contenant les coefficients de réflexion ambiant pour le rouge, le vert et le bleu
     * @param dif tableau contenant les coefficients de réflexion diffus pour le rouge, le vert et le bleu
     ...
     * @return Une chaîne de caractères qui représente le matériau. les coefficients de réflextion ambiants, diffus et spéculaire sont affichés
     */
